...
# cookie_multitenant/
APPS_DIR = BASE_DIR / "cookie_multitenant"
env = environ.Env()
...
SHARED_APPS = [
    ...
    # shared apps
    "cookie_multitenant.tenants.apps.TenantsConfig",
    "cookie_multitenant.core",
]
...
MIGRATION_MODULES = {"sites": "cookie_multitenant.contrib.sites.migrations"}
...
ADMINS = ['"mrchego" <mrchegoprime@gmail.com>']
